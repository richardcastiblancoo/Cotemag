<section class="conocenos">
    ...
    <div class="ctmg-declaracion-mision">
        <p class="ctmg-texto-mision">
        ...
        <div class="ctmg-divisor"></div>
    </div>

    <div class="ctmg-cuadricula-programas">
        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-salud')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-azul"><i class="fa-solid fa-heart-crack"></i></div>
            <div class="ctmg-titulo-tarjeta">Área de Salud</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-administrativa')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-amarillo"><i class="fas fa-briefcase"></i></div>
            <div class="ctmg-titulo-tarjeta">Área Administrativa</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-salud-animal')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-rosa"><i class="fas fa-paw"></i></div>
            <div class="ctmg-titulo-tarjeta">Área de Salud Animal</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-educacion')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-morado"><i class="fas fa-graduation-cap"></i></div>
            <div class="ctmg-titulo-tarjeta">Área de Educación</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-sistemas')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-morado"><i class="fas fa-desktop"></i></div>
            <div class="ctmg-titulo-tarjeta">Área de Análisis y desarrollo de sistemas de la información</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-bachillerato')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-rosa"><i class="fas fa-user-graduate"></i></div>
            <div class="ctmg-titulo-tarjeta">Bachillerato por Ciclos CLEI</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-diplomados')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-amarillo"><i class="fas fa-certificate"></i></div>
            <div class="ctmg-titulo-tarjeta">Diplomados y Cursos</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-gastronomia')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-azul"><i class="fas fa-utensils"></i></div>
            <div class="ctmg-titulo-tarjeta">Área de Gastronomía</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-industrial')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-azul"><i class="fas fa-industry"></i></div>
            <div class="ctmg-titulo-tarjeta">Área Industrial</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-idiomas')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-amarillo"><i class="fas fa-language"></i></div>
            <div class="ctmg-titulo-tarjeta">Área de Idiomas</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-investigativa')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-rosa"><i class="fas fa-search"></i></div>
            <div class="ctmg-titulo-tarjeta">Área Investigativa y Judicial</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-diseno')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-azul"><i class="fas fa-paint-brush"></i></div>
            <div class="ctmg-titulo-tarjeta">Área de Diseño</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-belleza')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-rosa"><i class="fas fa-spa"></i></div>
            <div class="ctmg-titulo-tarjeta">Belleza y Bienestar Corporal</div>
        </div>

        <div class="ctmg-tarjeta-programa" onclick="abrirModal('modal-servicios')">
            <div class="ctmg-icono-tarjeta ctmg-fondo-gris"><i class="fas fa-cogs"></i></div>
            <div class="ctmg-titulo-tarjeta">Servicios Generales</div>
        </div>
    </div>

    <!-- Modales -->
    <div id="modal-salud" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área de Salud</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-salud')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
                <p>Área de Salud
    ...
    <div id="modal-administrativa" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área Administrativa</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-administrativa')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
    ...
    <div id="modal-salud-animal" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área de Salud Animal</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-salud-animal')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
    ...
    <div id="modal-educacion" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área de Educación</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-educacion')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
                <p>Área de Educación
    ...
    <div id="modal-sistemas" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área de Sistemas</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-sistemas')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
...
El egresado de Técnico Laboral en Asistente en Análisis y Desarrollo de Software estará en capacidad de analizar, modelar, desarrollar e implementar soluciones informáticas en entornos web y dispositivos móviles que permitan la optimización de procesos y el manejo de información de la empresa.</p>
    ...
    <div id="modal-bachillerato" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Bachillerato por Ciclos CLEI</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-bachillerato')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
    ...
    <div id="modal-diplomados" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Diplomados y Cursos</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-diplomados')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
    ...
    <div id="modal-gastronomia" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área de Gastronomía</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-gastronomia')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
    ...
    <div id="modal-industrial" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área Industrial</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-industrial')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
                <p>Área Industrial
    ...
    <div id="modal-idiomas" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área de Idiomas</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-idiomas')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
                <p>Área de Idiomas
    ...
    <div id="modal-investigativa" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área Investigativa y Judicial</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-investigativa')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
    ...
    <div id="modal-diseno" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área de Diseño</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-diseno')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
                <p>Área de Diseño
    ...
    <div id="modal-belleza" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Área de Belleza y Bienestar Corporal</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-belleza')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
    ...
    <div id="modal-servicios" class="ctmg-modal">
        <div class="ctmg-contenido-modal">
            <div class="ctmg-cabecera-modal">
                <h2>Servicios Generales</h2>
                <span class="ctmg-cerrar" onclick="cerrarModal('modal-servicios')">&times;</span>
            </div>
            <div class="ctmg-cuerpo-modal">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.ctmg-modal').forEach(modal => {
        ...
        function abrirModal(id) {
            ...
            setTimeout(() => modal.classList.add('ctmg-mostrar'), 10);
        }

        // Función para cerrar modal
        function cerrarModal(id) {
            const modal = typeof id === 'string' ? document.getElementById(id) : id;
            modal.classList.remove('ctmg-mostrar');
